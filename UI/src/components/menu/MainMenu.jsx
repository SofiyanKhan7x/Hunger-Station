    ...
    <>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? "bg-gradient-to-r from-[#BF1E2E] to-[#BF1E2E] text-white shadow-md"
      ...
      {cartCount > 0 && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 flex items-center gap-3 rounded-full bg-[#BF1E2E] px-6 py-4 text-white shadow-xl transition hover:bg-[#9F1826] hover:scale-105 active:scale-[0.98]"
        >
          <span className="text-lg font-semibold">View Cart</span>

          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#F4CA13] text-sm font-bold text-black">
            {cartCount}
          </span>
        </button>
